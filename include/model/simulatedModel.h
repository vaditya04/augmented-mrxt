...
public:
    ...
    //records the ground truth history of poses of all the robots
    vector<vector<pose> > gtlogvector;

    //calculates the euclidean distance between 2 points in cartesian plane
